...
clang_bin="$HOME/Projects/toolchains/proton_clang-10.0.0-20200104/bin"

# 64-bit GCC toolchain prefix
gcc_prefix64="$HOME/Projects/toolchains/proton_clang-10.0.0-20200104/bin/aarch64-linux-gnu-"

# 32-bit GCC toolchain prefix
gcc_prefix32="$HOME/Projects/toolchains/proton_clang-10.0.0-20200104/bin/arm-linux-gnueabi-"
